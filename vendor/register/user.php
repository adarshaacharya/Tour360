                    ...
                    <div class="card">
                        ...
                        <form action="upload.php" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                <input name="phone" type="number" id="phone" class="form-control mb-4" placeholder="Phone No.">
                            </div>
                            ...
                            <div class="form-group">
                                <input name="pass" type="password" id="password" class="form-control mb-4" placeholder="Password">
                            </div>
